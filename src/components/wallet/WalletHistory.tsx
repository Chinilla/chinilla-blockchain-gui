...
import { Card, CopyToClipboard, Flex, Table } from '@chinilla/core';
  ...
  },
  {
    field: (row: Row) =>
      type === WalletType.COLOURED_COIN
        ? chin_to_colouredcoin_string(row.amount)
        : chin_to_chinilla_string(row.amount),
    title: <Trans>Amount</Trans>,
  },
  {
    field: (row: Row) => chin_to_chinilla_string(row.fee_amount),
