...
import { AlertDialog, Card, Flex } from '@chinilla/core';
      ...
      <Box display="flex">
        ...
        <Box>
          <Typography variant="subtitle1">
            {chin_to_colouredcoin_string(props.balance)} {cc_unit}
          </Typography>
        </Box>
      </Box>
    </Grid>
...
function BalanceCard(props: BalanceCardProps) {
  ...
  const balance_ptotal_chinilla = chin_to_colouredcoin_string(balance_ptotal);
  const balance_pending_chinilla = chin_to_colouredcoin_string(balance_pending);
  const balance_change_chinilla = chin_to_colouredcoin_string(balance_change);
  const acc_content =
    balancebox_1 +
    balancebox_2 +
    balancebox_ptotal +
    balancebox_3 +
    balance_ptotal_chinilla +
    balancebox_unit +
    balancebox_hline +
    balancebox_4 +
    balancebox_row +
...
function SendCard(props: SendCardProps) {
  ...
  function send() {
    ...
    const amount = colouredcoin_to_chin(amount_input.value);
    const fee = colouredcoin_to_chin(fee_input.value);
