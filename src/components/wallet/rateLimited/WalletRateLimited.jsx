...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const chinillaper_input = ip_parsed.limit;
    ...
    const chinillaper_value = Number.parseInt(Number(chinillaper_input));
...
const SendCard = (props) => {
  ...
  function send() {
    ...
    const fee = chinilla_to_chin(fee_input.value);
