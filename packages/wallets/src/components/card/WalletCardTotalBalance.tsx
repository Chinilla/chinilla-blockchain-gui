import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@chinilla/api-react';
import { CardSimple, Flex, TooltipIcon } from '@chinilla/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for HCX, CATs, or
