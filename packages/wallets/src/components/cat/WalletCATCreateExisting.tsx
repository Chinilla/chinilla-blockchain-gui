...
import { AlertDialog, Fee, Back, ButtonLoading, Card, Flex, Form, TextField } from '@chinilla/core';
      ...
      <Flex flexDirection="column" gap={3}>
        <Back variant="h5">
          {asteroid 
            ...
            : <Trans>Create Chinilla Asset Token Wallet from Existing TAIL</Trans>}
