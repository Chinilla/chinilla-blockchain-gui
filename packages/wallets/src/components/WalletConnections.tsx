import { Connection, ServiceConnectionName } from '@chinilla/api';
import { useGetWalletConnectionsQuery } from '@chinilla/api-react';
import { Card, FormatBytes, Loading, Table } from '@chinilla/core';
