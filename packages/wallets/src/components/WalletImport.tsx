...
import { useAddPrivateKeyMutation, useLogInMutation } from '@chinilla/api-react';
import {
  AlertDialog,
  Autocomplete,
  Button,
      ...
      <Container maxWidth="lg">
        <Flex flexDirection="column" gap={3} alignItems="center">
          ...
          <Typography variant="subtitle1" align="center">
            <Trans>Enter the 24 word mnemonic that you have saved in order to restore your Chinilla wallet.</Trans>
          </Typography>
