          ...
          <Flex flexDirection="column" gap={3}>
            <Flex flexDirection="column" gap={1}>
              <Flex alignItems="center" gap={1}>
                ...
                <Tooltip title="The amount of Chinilla you enter must correspond to an even amount of vojos. One additional vojo will be added to the total amount for security purposes.">
                  ...
                  >
                    {() => (
                      <Flex display="flex" gap={1} alignItems="center">
                        <div>+ 1 vojo</div>
                        <Tooltip title="This additional vojo will be added to the total amount for security purposes.">
                          <HelpIcon
