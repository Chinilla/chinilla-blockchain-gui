...
test('Create new Wallet and logout', async () => {
  ...
  // assert.equal(page.url(), 'file:///Users/jahifaw/Documents/Code/Chinilla-testnet-playwright/chinilla-blockchain/chinilla-blockchain-gui/packages/gui/build/renderer/index.html#/wallet/add');
