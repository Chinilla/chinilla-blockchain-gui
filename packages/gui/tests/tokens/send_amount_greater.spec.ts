...
test('Confirm that User cannot send a THCX amount greater then in Wallet', async () => {
  let receive_wallet = 'thcx1u237ltq0pp4348ppwv6cge7fks87mn4wz3c0ywvgswvpwhkqqn8qn8jeq6';
  ...
  console.log(`HCX Balance: ${balance}`);
  ...
  await page.locator('text=Fee *THCX >> input[type="text"]').fill('0.000005');
  ...
  await expect(page.locator('text=Pending Balance0 THCX')).toBeVisible();
});
