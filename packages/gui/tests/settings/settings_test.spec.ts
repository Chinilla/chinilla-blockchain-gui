...
test('Confirm user can navigate and interact the Settings page in user acceptable manner. ', async () => {
  ...
  await Promise.all([
    page.waitForNavigation(/*{ url: 'file:///Users/jahifaw/Documents/Code/Chinilla-testnet-playwright/chinilla-blockchain/chinilla-blockchain-gui/packages/gui/build/renderer/index.html#/dashboard/wallets/1' }*/),
  ...
  // assert.equal(page.url(), 'file:///Users/jahifaw/Documents/Code/Chinilla-testnet-playwright/chinilla-blockchain/chinilla-blockchain-gui/packages/gui/build/renderer/index.html#/dashboard/settings');
