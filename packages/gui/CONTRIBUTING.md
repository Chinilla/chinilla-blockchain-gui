...
It is an input to the [chinilla-blockchain](https://github.com/Chinilla/chinilla-blockchain) repository which also includes a verifiable delay function implementation that it imports from the [chinillavdf repo](https://github.com/Chinilla/chinillavdf) (in c/c++), and a proof of space implementation that it imports from the [chiapos repo](https://github.com/Chinilla/chiapos). BLS signatures are imported from the [bls-signatures repo](https://github.com/Chinilla/bls-signatures) as blspy. There is an additional dependency on the [chinillabip158 repo](https://github.com/Chinilla/chinillabip158).
