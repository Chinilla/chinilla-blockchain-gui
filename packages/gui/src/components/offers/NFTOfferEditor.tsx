      ...
      <Flex flexDirection="row" alignItems="center" gap={1}>
        ...
        <TooltipIcon>
          <Trans>
            ...
            the offer is accepted. The recommended minimum fee is 0.000005 HCX
            (5,000,000 vojos)
          </Trans>
        </TooltipIcon>
      </Flex>
...
function NFTOfferConditionalsPanel(props: NFTOfferConditionalsPanelProps) {
  ...
  const offerElem =
    tab === NFTOfferExchangeType.NFTForHCX ? nftElem : amountElem;
  const takerElem =
    tab === NFTOfferExchangeType.NFTForHCX ? amountElem : nftElem;
  ...
  return (
    ...
    >
      ...
      >
        <Tab
          value={NFTOfferExchangeType.NFTForHCX}
          label={<Trans>NFT for HCX</Trans>}
          disabled={disabled}
        />
        <Tab
          value={NFTOfferExchangeType.HCXForNFT}
      ...
      <Grid container>
        <Flex flexDirection="column" flexGrow={1} gap={3}>
          ...
          {tab === NFTOfferExchangeType.HCXForNFT && (
            <Flex flexDirection="column" gap={2}>
          ...
          {nft?.royaltyPercentage && amount ? (
            <Flex flexDirection="column" gap={2}>
              <>
                <Flex flexDirection="column" gap={0.5}>
                  <Typography variant="body1" color="textSecondary">
                    {tab === NFTOfferExchangeType.NFTForHCX ? (
...
function buildOfferRequest(
  ...
  const nftAmount = exchangeType === NFTOfferExchangeType.NFTForHCX ? -1 : 1;
  const xchWalletId = 1;
  ...
  return [
    ...
    exchangeType === NFTOfferExchangeType.HCXForNFT ? driverDict : undefined,
    // driverDict,
    feeVojoAmount,
  ];
}
