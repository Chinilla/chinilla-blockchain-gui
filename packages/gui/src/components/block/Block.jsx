...
export default function Block() {
  ...
  const baseFarmerReward = vojoToChinilla(calculateBaseFarmerReward(blockRecord.height));

  const chinillaFees = blockRecord.fees !== undefined ? vojoToChinilla(blockRecord.fees) : '';
  ...
  return (
    <LayoutDashboardSub>
      <Card
        title={
          <Back variant="h5">
            <Trans>Block at height {blockRecord.height} in the Chinilla blockchain</Trans>
          </Back>
        }
        action={
          <Flex gap={1}>
