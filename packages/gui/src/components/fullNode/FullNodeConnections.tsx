import { Connection } from '@chinilla/api';
import { useGetFullNodeConnectionsQuery } from '@chinilla/api-react';
import { Card, FormatBytes, FormatLargeNumber, IconButton, Loading, Table, useOpenDialog } from '@chinilla/core';
