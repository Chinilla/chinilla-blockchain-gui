import { Button, Flex } from '@chinilla/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Chinilla application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Chinilla services version: {backV}
                <br />
                Chinilla application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Chinilla application and stop all Chinilla services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
