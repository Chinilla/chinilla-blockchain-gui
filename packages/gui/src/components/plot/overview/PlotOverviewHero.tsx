import { useRefreshPlotsMutation } from '@chinilla/api-react';
import { Button, CardHero, Flex, Link, useOpenDialog } from '@chinilla/core';
import { Plots } from '@chinilla/icons';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link target="_blank" href="https://github.com/Chinilla/chinilla-blockchain/wiki/Network-Architecture">
                Learn more
              </Link>
            </Trans>
          </Typography>
