...
import { CardStep, Select, StateColor } from '@chinilla/core';
import { useGetPlottersQuery } from '@chinilla/api-react';
import {
  FormControl,
  FormHelperText,
  Grid,
...
import { defaultPlotter, PlotterName } from '@chinilla/api';
import type { Plotter, PlotterMap } from '@chinilla/api';
    ...
    <CardStep step={step} title={<Trans>Choose Plotter</Trans>}>
      <Typography variant="subtitle1">
        <Trans>
            ...
            produces plots faster than the default Chinilla Proof of Space plotter. If unsure,
            use the default Chinilla Proof of Space plotter.
        </Trans>
      </Typography>
