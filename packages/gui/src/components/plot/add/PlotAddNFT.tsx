import { Button, CardStep, Select, Flex, Loading } from '@chinilla/core';
  ...
  if (showCreatePlotNFT) {
    return (
      <PlotNFTSelectPool
        ...
        description={
          <Trans>
            Join a pool and get consistent HCX farming rewards. The average returns are the same, but it is much less
            volatile.
          </Trans>
        }
      />
    ...
    >
      ...
      {!loading && !hasNFTs && (
        <>
          <Typography variant="subtitle1">
            <Trans>
              Join a pool and get more consistent HCX farming rewards. Create a plot NFT and assign your new plots to a
              group.
            </Trans>
          </Typography>
