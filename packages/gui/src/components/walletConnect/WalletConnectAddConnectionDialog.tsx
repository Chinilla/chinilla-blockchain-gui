import { useGetKeysQuery, useGetLoggedInFingerprintQuery } from '@chinilla/api-react';
import {
  ButtonLoading,
  DialogActions,
  Flex,
...
import HeroImage from './images/walletConnectToChinilla.svg';
...
export default function WalletConnectAddConnectionDialog(props: WalletConnectAddConnectionDialogProps) {
  ...
  const vanillanet = useCurrencyCode() === 'HCX';
  ...
  async function handleSubmit(values: FormData) {
    ...
    const topic = await pair(uri, selectedFingerprints, vanillanet);
    onClose(topic);
  }
