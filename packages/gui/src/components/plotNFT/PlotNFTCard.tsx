import { useDeleteUnconfirmedTransactionsMutation } from '@chinilla/api-react';
import {
  Button,
  TooltipTypography,
  Flex,
...
import { Plot as PlotIcon } from '@chinilla/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={vojoToChinillaLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
