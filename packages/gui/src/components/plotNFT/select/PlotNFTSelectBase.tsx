import { Button, Flex, Loading, CardStep, RadioGroup, EstimatedFee, TextField } from '@chinilla/core';
            ...
            <FormControl variant="filled" fullWidth>
              <RadioGroup name="self" boolean>
                <Flex gap={1} flexDirection="column">
                  <FormControlLabel
                    control={<Radio />}
                    label={<Trans>Self pool. When you win a block you will earn HCX rewards.</Trans>}
                    value
                  />
                  <Flex gap={2}>
