import { Button, CopyToClipboard, Flex, Link, Loading, TextField, Form } from '@chinilla/core';
            ...
            {loading ? (
              ...
              <Flex flexDirection="column" gap={2}>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    These are the instructions for how the farmer wants to get paid. By default this will be an HCX
                  ...
                  <Link
                    target="_blank"
                    href="https://github.com/Chinilla/pool-reference/blob/main/SPECIFICATION.md#payloadpayout_instructions"
                    noWrap
                  >
