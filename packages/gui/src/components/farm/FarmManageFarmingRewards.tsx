import { fromBech32m } from '@chinilla/api';
import { useSetRewardTargetsMutation, useGetRewardTargetsQuery } from '@chinilla/api-react';
import { Button, Flex, Form, TextField, Loading } from '@chinilla/core';
              ...
              <>
                ...
                <Typography variant="body2" color="textSecondary">
                  <Trans>
                    ...
                    and the 0.25HCX reward for pooling plots.
                  </Trans>
                </Typography>
              </>
            )}
