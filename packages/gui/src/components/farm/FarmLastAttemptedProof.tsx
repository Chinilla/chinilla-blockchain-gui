...
import { Link, Loading, Table, Card, FormatBytes } from '@chinilla/core';
import { useGetFarmingInfoQuery } from '@chinilla/api-react';
    ...
    <Card
      ...
      tooltip={
        <Trans>
          ...
          <Link
            target="_blank"
            href="https://github.com/Chinilla/chinilla-blockchain/wiki/FAQ#what-is-the-plot-filter-and-why-didnt-my-plot-pass-it"
          >
            Learn more
          </Link>
        </Trans>
