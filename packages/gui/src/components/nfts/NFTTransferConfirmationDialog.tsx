import { useCurrencyCode, chinillaToVojo, ConfirmDialog, Flex, TooltipIcon, FormatLargeNumber } from '@chinilla/core';
...
export default function NFTTransferConfirmationDialog(props: NFTTransferConfirmationDialogProps) {
  ...
  const feeInVojos = chinillaToVojo(fee || 0);
      ...
      <Flex flexDirection="column" gap={3}>
        ...
        <Flex flexDirection="column" gap={1}>
          ...
          <Flex flexDirection="row" gap={1}>
            ...
            {feeInVojos > 0 && (
              <>
                <FormatLargeNumber value={feeInVojos} />
                <Box>
                  <Plural value={feeInVojos.toNumber()} one="vojo" other="vojos" />
                </Box>
              </>
            )}
          </Flex>
