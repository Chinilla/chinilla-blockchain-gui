...
export default function ProfileAdd() {
  ...
  function handleClick() {
    openExternal('https://faucet.chinilla.net/');
  }
      ...
      <Form methods={methods} onSubmit={handleSubmit}>
        ...
        <StyledCard>
          <Flex flexDirection="column" gap={2.5} paddingBottom={1}>
            <Trans><strong>Need some HCX?</strong></Trans>
          </Flex>
          <div style={{cursor: "pointer"}}>
            <Flex paddingBottom={5}>
              <Typography onClick={handleClick} sx={{ textDecoration: "underline" }}>Get Vojos from the Chinilla Faucet</Typography>
            </Flex>
          </div>
          <Flex flexDirection="column" gap={2.5} paddingBottom={1}>
            <Trans><strong>Use one (1) vojo to create a Profile.</strong></Trans>
          </Flex>
          <Flex flexDirection="column" gap={2.5} paddingBottom={3}>
