...
import { useGetCatListQuery } from '@chinilla/api-react';
import {
  CopyToClipboard,
  Flex,
  FormatLargeNumber,
  ...
  const rows = useMemo(
    () =>
      royalties?.map((royalty) => {
        ...
        if (assetLowerCase === 'hcx' || assetLowerCase === currencyCode.toUpperCase()) {
          return {
            address,
            amount: vojoToChinilla(amount),
