...
// Set the userData directory to its location within CHINILLA_ROOT/gui
setUserDataDir();
      ...
      submenu: [
        {
          ...
          click: () => {
            openExternal('https://github.com/Chinilla/chinilla-blockchain/wiki');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Frequently Asked Questions' }),
          click: () => {
            openExternal('https://github.com/Chinilla/chinilla-blockchain/wiki/FAQ');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Release Notes' }),
          click: () => {
            openExternal('https://github.com/Chinilla/chinilla-blockchain/releases');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Contribute on GitHub' }),
          click: () => {
            openExternal('https://github.com/Chinilla/chinilla-blockchain/blob/main/CONTRIBUTING.md');
          },
        },
        {
          type: 'separator',
        },
        {
          ...
          click: () => {
            openExternal('https://github.com/Chinilla/chinilla-blockchain/issues');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Chat on Discord' }),
          click: () => {
            openExternal('https://discord.gg/HKGNjrBknN');
          },
        },
        {
          label: i18n._(/* i18n */ { id: 'Visit Chinilla.com' }),
          click: () => {
